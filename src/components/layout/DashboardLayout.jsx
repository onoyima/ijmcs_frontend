...
const DashboardLayout = () => {
  ...
  const menuItems = {
    admin: [
      ...
      { icon: User,            label: 'Personal Dashboard',path: '/dashboard' },
  ...
  return (
    <div className="flex min-h-screen bg-neutral-50 relative">
      ...
      <button 
        ...
        className="lg:hidden fixed top-4 left-4 z-[45] p-3 bg-brand-900 text-white rounded-xl shadow-2xl border border-brand-800 active:scale-95 transition-all"
      >
        <Menu size={20} />
      </button>
